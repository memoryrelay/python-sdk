...
def test_api_error():
    ...
    error = APIError(
        "API error occurred", status_code=500, response={"error": "details"}, request_id="req_123"
    )
...
def test_authentication_error():
    ...
    error = AuthenticationError("Invalid API key", status_code=401, request_id="req_456")
...
def test_rate_limit_error():
    ...
    error = RateLimitError("Rate limit exceeded", retry_after=60, request_id="req_789")
